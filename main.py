...
score = 0
moves = 0
# While working on this exercise, anytime I would work around the pre-existing code, 
# errors involving the indents occured, even though I had the correct number of 
# indents required for each code block. I don't know if thats a me problem,
# or if how this code was formatted that causing these errors to pop up whenever i edit your code

#EX: the code below is the code you gave me. when i added the last 2 lines of code, it threw an error
# while True:
# 	if response == "QUIT":
# 		break
...
#EX: I rewrote the code exactly as written below. No errors this time.
while True:
  if response == "QUIT":
    break
  if "score" in current_location:
